...
var browser_name = (jQuery.browser.msie ? "ie" : (jQuery.browser.webkit ? "webkit" : (jQuery.browser.mozilla ? "mozilla" : "unknown")));
$.getScript("/compiler/?request=/ijs/theitf:theitf;aboutedit&SA=1&browser="+browser_name+""+(jQuery.browser.version ? jQuery.browser.version : "0")+"&v=1.05", function () {
    setTimeout(function() {
