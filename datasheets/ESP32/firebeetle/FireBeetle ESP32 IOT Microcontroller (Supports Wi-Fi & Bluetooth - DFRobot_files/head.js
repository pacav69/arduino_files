			...
			$(window).scroll(function(e) {
				...
				if(topNum > 706){
					switch(sd){
						case "down":
							if(navPo != "fixed"){
								$(".headFrame .pc").css({position:"fixed",opacity:0});
							}
							if(ifShow != "on"){
								$(".headFrame .pc").stop(true);
								$(".headFrame .pc").addClass("small");
								$(".headFrame .pc").animate({opacity:1},200);
					...
					if(navPo == "fixed" && ifShow == "on"){
						...
						$(".headFrame .pc").stop(true);
						$(".headFrame .pc").animate({opacity:0},200,function(){
							$(".headFrame .pc").css({position:"static",opacity:1});
							$(".headFrame .pc").removeClass("small");
						});
